...
namespace Launcher.UI
{
    public static class UiTheme
    {
        public static void Apply()
        {
            ...
            colors[(int)ImGuiCol.WindowBg] = new Vector4(0.08f, 0.08f, 0.09f, 1.00f);
            colors[(int)ImGuiCol.ChildBg] = new Vector4(0.11f, 0.11f, 0.12f, 1.00f);
            colors[(int)ImGuiCol.PopupBg] = new Vector4(0.14f, 0.14f, 0.15f, 1.00f);
            colors[(int)ImGuiCol.Border] = new Vector4(0.25f, 0.25f, 0.27f, 1.00f);
            ...
            colors[(int)ImGuiCol.TitleBg] = new Vector4(0.07f, 0.07f, 0.08f, 1.00f);
            colors[(int)ImGuiCol.TitleBgActive] = new Vector4(0.09f, 0.09f, 0.10f, 1.00f);
            colors[(int)ImGuiCol.Button] = new Vector4(0.15f, 0.35f, 0.60f, 1.00f);
            colors[(int)ImGuiCol.ButtonHovered] = new Vector4(0.20f, 0.45f, 0.75f, 1.00f);
            colors[(int)ImGuiCol.ButtonActive] = new Vector4(0.25f, 0.55f, 0.90f, 1.00f);
