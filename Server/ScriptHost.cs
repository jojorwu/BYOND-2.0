...
namespace Server
{
    public class ScriptHost : IDisposable, IScriptHost
    {
        ...
        public ScriptHost(Project project, ServerSettings settings, IServiceProvider serviceProvider, ILogger<ScriptHost> logger, ILogger<ScriptingEnvironment> scriptingEnvironmentLogger)
        {
            _project = project;
            _settings = settings;
