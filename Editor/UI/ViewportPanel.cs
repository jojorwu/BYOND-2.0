...
namespace Editor.UI
{
    public class ViewportPanel : IDisposable
    {
        ...
        public ViewportPanel(GL gl, GameApi gameApi, ToolManager toolManager, SelectionManager selectionManager, EditorContext editorContext, SpriteRenderer spriteRenderer, TextureManager textureManager)
        {
            _gl = gl;
            _gameApi = gameApi;
