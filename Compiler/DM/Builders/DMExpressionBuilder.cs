...
internal class DMExpressionBuilder(
    ...
    DMExpressionBuilder.ScopeMode scopeMode = Normal,
    bool scopeOperatorEnabled = false) {
    ...
    private readonly bool _scopeOperatorEnabled = scopeOperatorEnabled; // Enabled on the last pass of the code tree
