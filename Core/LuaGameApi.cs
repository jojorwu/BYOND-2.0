...
namespace Core
{
    public class LuaGameApi
    {
        ...
        public IGameObject? CreateObject(int typeId, int x, int y, int z) => _gameApi.Objects.CreateObject(typeId, x, y, z);
        public IGameObject? GetObject(int id) => _gameApi.Objects.GetObject(id);
