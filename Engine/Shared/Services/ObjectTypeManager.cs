...
[EngineService(typeof(IObjectTypeManager))]
public class ObjectTypeManager : EngineService, IObjectTypeManager, IFreezable
{
    ...
    public IEnumerable<ObjectType> GetAllObjectTypes() => _objectTypes.Values;

    public ObjectType GetTurfType() => GetObjectType("/turf") ?? throw new System.InvalidOperationException("Base turf type '/turf' is not registered.");
