...
public class AssetBrowserPanel : IEditorPanel
{
    ...
    public void Render()
    {
        ...
        {
            ImGui.TextColored(new System.Numerics.Vector4(1, 0, 0, 1), $"Error: {e.Message}");
        }
        ImGui.EndChild();
    }
}
...
public class ConsolePanel : IEditorPanel
{
    ...
    {
        // Clone event because it might be reused
    ...
    public void Render()
    {
        ...
        lock (_logs)
        {
            foreach (var log in _logs)
            {
                ...
                {
                    DiagnosticSeverity.Error => new System.Numerics.Vector4(1, 0.4f, 0.4f, 1),
                    DiagnosticSeverity.Warning => new System.Numerics.Vector4(1, 1, 0.4f, 1),
