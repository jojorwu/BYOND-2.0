...
namespace tests
{
    ...
    public class SpatialGridSyncTests
    {
        ...
        public void GameObject_Moving_UpdatesSpatialGrid()
        {
            ...
            var initialObjects = grid.GetObjectsInBox(new Robust.Shared.Maths.Box2i(0, 0, 32, 32));
            ...
            var oldCellObjects = grid.GetObjectsInBox(new Robust.Shared.Maths.Box2i(0, 0, 15, 15));
            var newCellObjects = grid.GetObjectsInBox(new Robust.Shared.Maths.Box2i(16, 16, 31, 31));
