...
public enum Opcode : byte {
    ...
    [OpcodeMetadata(1)] PushLocal3 = 0xD7,
    [OpcodeMetadata(1)] PushLocal4 = 0xD8,
    [OpcodeMetadata(1)] PushLocal5 = 0xD9,
    [OpcodeMetadata(1)] PushLocal6 = 0xDA,
    [OpcodeMetadata(1)] PushLocal7 = 0xDB,
    [OpcodeMetadata(1)] PushLocal8 = 0xDC,
    [OpcodeMetadata(1)] PushLocal9 = 0xDD,
    [OpcodeMetadata(1)] PushLocal10 = 0xDE,
    [OpcodeMetadata(1)] PushLocal11 = 0xDF,
    [OpcodeMetadata(1)] PushLocal12 = 0xE0,
    [OpcodeMetadata(1)] PushLocal13 = 0xE1,
    [OpcodeMetadata(1)] PushLocal14 = 0xE2,
    [OpcodeMetadata(1)] PushLocal15 = 0xE3,
    [OpcodeMetadata(0)] AssignLocal0 = 0xE4,
    [OpcodeMetadata(0)] AssignLocal1 = 0xE5,
    [OpcodeMetadata(0)] AssignLocal2 = 0xE6,
    [OpcodeMetadata(0)] AssignLocal3 = 0xE7,
    [OpcodeMetadata(0)] AssignLocal4 = 0xE8,
    [OpcodeMetadata(0)] AssignLocal5 = 0xE9,
    [OpcodeMetadata(0)] AssignLocal6 = 0xEA,
    [OpcodeMetadata(0)] AssignLocal7 = 0xEB,
    [OpcodeMetadata(0)] AssignLocal8 = 0xEC,
    [OpcodeMetadata(0)] AssignLocal9 = 0xED,
    [OpcodeMetadata(0)] AssignLocal10 = 0xEE,
    [OpcodeMetadata(0)] AssignLocal11 = 0xEF,
    [OpcodeMetadata(0)] AssignLocal12 = 0xF0,
