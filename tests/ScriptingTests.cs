...
namespace tests
{
    ...
    public class ScriptingIntegrationTests
    {
        ...
        public void SetUp()
        {
            ...
            _dreamVM = new DreamVM(Options.Create(new ServerSettings()), NullLogger<DreamVM>.Instance, new INativeProcProvider[] { new Core.VM.Procs.StandardNativeProcProvider() }, new Core.Services.DynamicLimitService(), objectFactory);
