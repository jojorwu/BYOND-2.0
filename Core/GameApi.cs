...
namespace Core
{
    ...
    public class GameApi : IMapApi, IObjectApi, IStandardLibraryApi
    {
        ...
        public GameApi(IMapApi mapApi, IObjectApi objectApi, IStandardLibraryApi standardLibraryApi, Project project)
        {
            _mapApi = mapApi;
        ...
        // IStandardLibraryApi delegation
        ...
        // Script file management methods remain here as they depend on Project
