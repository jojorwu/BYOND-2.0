...
internal partial class DMCodeTree {
    public abstract class VarNode : INode {
        ...
        protected bool TryBuildValue(ExpressionContext ctx, bool scopeOperatorEnabled, DMASTExpression ast, DreamPath? inferredType,
            ScopeMode scope, [NotNullWhen(true)] out DMExpression? value) {
            var exprBuilder = new DMExpressionBuilder(ctx, scopeOperatorEnabled, scope);
    ...
    private class ObjectVarNode(DreamPath owner, DMASTObjectVarDefinition varDef) : VarNode {
        ...
        private bool HandleGlobalVar(DMCompiler compiler, DMObject dmObject, int pass, bool scopeOperatorEnabled) {
            ...
            if (!TryBuildValue(new(compiler, dmObject, compiler.GlobalInitProc), scopeOperatorEnabled, expression, varDef.Type, scope, out var value))
                return false;
        ...
        private bool HandleInstanceVar(DMCompiler compiler, DMObject dmObject, bool scopeOperatorEnabled) {
            ...
            if (!TryBuildValue(exprContext, scopeOperatorEnabled, expression, varDef.Type, ScopeMode.Normal, out var value))
                return false;
    ...
    private class ObjectVarOverrideNode(DreamPath owner, DMASTObjectVarOverride varOverride) : VarNode {
        ...
        public override bool TryDefineVar(DMCompiler compiler, int pass, bool scopeOperatorEnabled) {
            ...
            if (!TryBuildValue(new(compiler, dmObject, compiler.GlobalInitProc), scopeOperatorEnabled, expression, variable.Type, ScopeMode.Normal, out var value))
                return false;
    ...
    private class ProcGlobalVarNode(DreamPath owner, DMProc proc, DMASTProcStatementVarDeclaration varDecl) : VarNode {
        ...
        public override bool TryDefineVar(DMCompiler compiler, int pass, bool scopeOperatorEnabled) {
            ...
            if (expression != null) {
                ...
                if (!TryBuildValue(exprContext, scopeOperatorEnabled, expression, varDecl.Type, scope, out value))
                    return false;
            }
