...
public partial class DreamThread : IScriptThread, IDisposable
{
    ...
    internal bool HandleException(ScriptRuntimeException e)
    {
        if (_tryStackPtr > 0)
        {
            ...
            if (tryBlock.CatchReference.HasValue)
            {
                ...
                ReferenceResolver.SetValue(tryBlock.CatchReference.Value, this, ref _callStack[_callStackPtr - 1], catchValue, 0);
    ...
    {
        return ReferenceResolver.GetValue(reference, this, ref frame, stackOffset);
    }
    ...
    {
        ReferenceResolver.SetValue(reference, this, ref frame, value, stackOffset);
    }
