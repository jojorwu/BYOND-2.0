    ...
    public class MenuBarPanel
    {
        ...
        public void Draw()
        {
            ...
            if (ImGui.BeginPopupModal("ProjectSettingsDlgKey"))
            {
                ...
                {
                    var settings = _editorContext.ClientSettings;
                    ImGui.InputInt("Resolution Width", ref settings.ResolutionWidth);
                    ImGui.InputInt("Resolution Height", ref settings.ResolutionHeight);
                    ImGui.Checkbox("Fullscreen", ref settings.Fullscreen);
                    ImGui.Checkbox("VSync", ref settings.VSync);
                }
