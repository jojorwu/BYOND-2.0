...
namespace tests
{
    ...
    public class GameLoopTests
    {
        ...
        public void SetUp()
        {
            ...
            _serverContextMock.Setup(c => c.PerformanceMonitor).Returns(new PerformanceMonitor(new Mock<ILogger<PerformanceMonitor>>().Object, new Mock<IDiagnosticBus>().Object, null));
